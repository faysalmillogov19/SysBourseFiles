              ...
              <form role="form" id="quickForm" method="POST" action="/compte/add" enctype="multipart/form-data" >
				  {{ csrf_field() }}
					<div class="card-body row candidatPart">
						...
						<input type="hidden" name="compte" value="{{ $my_request->compte_id}}" >
					...
					<div class="card-body row dossierPart">
					  ...
					  <div class="form-group col-6">
						...
						<input type="number" name="num_compte" min="0" step="0.001" class="select2 form-control" value="{{$my_request->num_compte}}"  data-dropdown-css-class="select2-purple" style="width: 100%;" required>
							
					  </div>
					  <div class="form-group col-6">
						<label for="exampleInputEmail1">Libelle du compte*</label>
						<input type="text" name="libelle_compte" min="0" step="0.001" class="select2 form-control" value="{{$my_request->libelle_compte}}"  data-dropdown-css-class="select2-purple" style="width: 100%;" required>
					  ...
					  <div class="form-group col-6">
						...
						<select name="mode_paiement_id" class="select2 form-control"   data-dropdown-css-class="select2-purple" style="width: 100%;" required>
								...
								<option value="{{$my_request->mode_paiement_id}}">{{$my_request->libelle_mode}}</option>
					  ...
					  <div class="form-group col-6">
						...
						<select name="banque_id" class="select2 form-control"   data-dropdown-css-class="select2-purple" style="width: 100%;" required>
							<option value="{{$my_request->banque_id}}">{{$my_request->libelle_banque}}</option>
					  ...
					  <div class="form-group col-6">
						...
						<input name="rib" class="select2 form-control" value="{{$my_request->rib}}"  data-dropdown-css-class="select2-purple" style="width: 100%;" >
